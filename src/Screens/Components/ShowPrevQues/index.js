    ...
    const selectoption = [
      {
        label: "Feeding",
        result:
          item?.questionnaire_answers?.quarter_feeding ||
      ...
      },
      {
        ...
        result:
          ...
          item?.questionnaire_answers?.full_chair_bed_transfer,
        value: [
      ...
      },
      {
        ...
        result:
          ...
          item?.questionnaire_answers?.full_wheelchair_management,
        value: [
      ...
      },
      {
        ...
        result:
          item?.questionnaire_answers?.quarter_on_and_off_toilet ||
          item?.questionnaire_answers?.full_on_and_off_toilet,
        value: [
                            ...
                            <Grid className="allQuestionShow1">
                              {selectoption.map((item) => (
                                <FormControl className="selectOption">
                                  <FormLabel
                                    id="main-topic-counted"
                                    className="mainQueLab"
                                  >
                                    {item.label}
                                  </FormLabel>
                                  {item.value?.map((option, index) => {
                                    const compareResult = parseInt(
                                      item &&
                                        item?.result &&
                                        item?.result?.value &&
                          ...
                          <Grid className="MainclassQues MainclassQues1">
                            ...
                            <Grid className="allQuestionShow1">
                              ...
                              "month If not acute daily" ? (
                                <p>{Month_If_not_acute_daily}</p>
                              ) : (
                                <p>{Could_the_Patient_tell_day}</p>
                              )}
                            </Grid>
                            ...
                            <Grid className="allQuestionShow1">
                              <h1>{Depression_Risk}</h1>
                              <h3>
                                {what_was_today} (every 2 Weeks If not acute
                                daily)
                              </h3>
                            ...
                            <Grid>
                              ...
                              <Grid container xs={12} md={12}>
                                ...
                                <Grid xs={4} md={4}>
                                  ...
                                  <label>{Have_you_been_trinkung}</label>
                                  {item?.questionnaire_answers
                                    ?.daily_thrombose_water_trinkung ===
                                  "yes" ? (
                                    <p>{Yes}</p>
                                  ) : (
                                    <p>{No}</p>
