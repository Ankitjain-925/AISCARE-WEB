        ...
        <a className="academy_ul stepTdotupper">
          ...
          <ul className={this.state.setSec && 'displayBlogCase'}  >
            {this.state.firstsec && <>
              ...
              {this.props.quote?.external_space && <li><a onClick={() => { MoveInternalSpace(this.props.quote._id, this.props.stateLoginValueAim.token, this) }}><p className="more-change-staff-img"><span className="more-assign-room"></span><p className="more-change-staff-img2">{"Move to internal space"}</p></p> </a></li>}
