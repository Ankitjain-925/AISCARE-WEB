                ...
                <Grid className="enterSpcl">
                  ...
                  <Grid>
                    {this.state.showError && (
                      <div className="err_message">{Please_select_atlest}</div>
                    )}
                    <label>{Addservice}</label>
                    <Select
                      name="service"
                      onChange={(e) => this.onFieldChange1(e, "service")}
                  ...
                  >
                    <VHfield
                      ...
                      value={this.state?.addservice?.price_per_quantity || 0}
                    />
                    <p className="enterPricePart3">€</p>
                  </Grid>
                  <Grid className="addSrvcBtn3">
                    <a onClick={this.handleAddSubmit}>{Add}</a>
                  </Grid>
                  <Grid item xs={12} md={12}>
                              ...
                              <Grid className="roomsNum3">
                                <Grid container direction="row">
                                  ...
                                  <Grid
                                    ...
                                    xs={6}
                                    md={6}
                                    className="wrdEdtDelBtn edtdelservice"
                                  >
                                    <img
                                      onClick={() => {
                  ...
                  <Grid className="enterSpcl">
                    ...
                    <Grid className="sevicessection serviceallSec">
                      <Select
                        ...
                        isDisabled={
                          this.props.comesFrom === "Professional" ? true : false
                        }
                      />
                    </Grid>
                  </Grid>
                        ...
                        <Grid item xs={12} sm={12} md={12}>
                          <Grid className="assignSec">
                            <>
                              <Grid
                                onClick={() => {
                                  this.createDuplicate(this.state.service);
                                }}
                              >
                                <img
                              ...
                              <Grid
                                ...
                                className="markDone"
                              >
                                {this.state.service?.status === "done" ? (
                              ...
                              {this.state.service?.archived == true ? (
                                <Grid
                                  onClick={() => {
                                    this.updateEntry(false, "archived");
                                  }}
                                ...
                                <Grid
                                  onClick={() => {
                                    this.updateEntry(true, "archived");
                                  }}
                                >
                                  <img
                    ...
                    <Grid className="enterSpcl">
                      ...
                      <Grid>
                        <VHfield
                          ...
                          placeholder={Enterserviceprice}
                          onChange={(e) =>
                            this.updateEntryState5(e, "price_per_quantity")
                          }
