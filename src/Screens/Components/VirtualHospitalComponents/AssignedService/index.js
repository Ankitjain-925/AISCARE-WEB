                ...
                <Grid className="enterSpcl">
                    ...
                    <Grid className="customservicetitle">
                      <Grid item xs={12} md={12}>
                        ...
                        <TextField
                          ...
                          name="custom_title"
                          onChange={(e) =>
                            this.onFieldChange1(e.target.value, "custom_title")
                          }
                  ...
                  >
                    <VHfield
                      ...
                      onChange={(e) =>
                        this.onFieldChange1(e.target.value, "price")
                      }
                      value={this.state?.service?.price || 0}
                    />
                  ...
                  <Grid item xs={12} md={12}>
                    ...
                    <Grid>
                      <Select
                        ...
                        onChange={(e) => this.patientField(e, "patient")}
