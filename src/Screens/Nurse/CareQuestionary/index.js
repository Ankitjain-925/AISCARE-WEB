...
import { handleChangeForm, updateAllEntrySec, handleSubmit, updateAllEntrySec1 } from "./api"
...
class Index extends Component {
    ...
    render() {
        ...
        const { rr_systolic, RR_diastolic } = translate;
        const { selectForm, dailyForm, everyDay, everyWeek, everyQuarter, allQuestionData } = this.state;
        return (
            <Grid
                className={
                    this.props.settings &&
                                                    ...
                                                    <Grid className="anamneSecMid">
                                                        ...
                                                        <Grid className="anamneSec">
                                                            <Grid>
                                                                ...
                                                                <input
                                                                    type="file"
                                                                    name="daily_picture_with_scale"
                                                                    onChange={(e) => updateAllEntrySec(this, e)}
                                                                    value={allQuestionData?.daily_picture_with_scale}
                                                                />
                                                            </Grid>
