                              ...
                              <Grid item xs={12} sm={12} md={9}>
                               ...
                               <Grid className="allFormSection">
                                <FormControl className="careQuesCheck careQuesCheckTp">
                                    <RadioGroup row aria-labelledby="openForms" name="row-radio-buttons-group">
                                        <FormControlLabel value="Daily" control={<Radio onClick={()=>this.handleDailyForm()} /> } label="Daily" />
                                        <FormControlLabel value="Every_2_Day" control={<Radio onClick={()=>this.handleEveryDay()} />} label="Every 2 Day" />
                                        <FormControlLabel value="Every_2_Weeks" control={<Radio onClick={()=>this.handleEveryWeek()} />} label="Every 2 Weeks" />
                                        <FormControlLabel value="Quarter" control={<Radio onClick={()=>this.handleEveryQuarter()} />} label="Quarter" />
                                    </RadioGroup>
                                </FormControl>
                               {dailyForm ?
                                  <Grid>
