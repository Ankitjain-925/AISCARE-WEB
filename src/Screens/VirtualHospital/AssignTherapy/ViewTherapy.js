            ...
            <Grid className="enterServMain">
              <Grid className="enterSpcl">
                <Grid className="allEnterSpclPart">
                  <Grid>
                    <label className="specbutton1">{Therapyname}</label>
                    <div className="addCssTherNamDes">
                      {props?.item?.therapy_name}
                    </div>
                  </Grid>
                  <Grid>
                    <label className="specbutton1">{Therapydescription}</label>
                    <div className="addCssTherNamDes">
                      {props?.item?.therapy_description}
                    </div>
                  </Grid>
                  <Grid>
                    <label className="specbutton1">{DiseaseName}</label>
                    <div className="addCssTherNamDes">
                    ...
                    props?.item?.assinged_to.map((data) => (
                      <>
                        {data?.first_name ? (
                          ...
                          <a
                            onClick={() =>
                              props.showData(data, data?.team_name)
                            }
                          >
                            {" "}
                            <div className="">
                ...
                <Grid className="allEnterSpclPart specbuttonPart">
                  <label>{Sequence_Task_Assigned_Services}</label>
                  {/* <div>-	</div> */}
                </Grid>
