...
class CometChatOutgoingDirectCall extends React.Component {
  ...
  startCall = () => {
    ...
    let sessionID = `16518148552a088a46ef5e363504885c78369deed073253c20`;
    let audioOnly = false;
    ...
    let callSettings = new CometChat.CallSettingsBuilder()
      ...
      .build();
    this.setState({ callInProgress: callSettings });
  ...
  render() {
    ...
    callScreen = (
      <CometChatCallScreen
        endCallScreen={(value) => this.props.endCallScreen(value)}
        userListCall={(userList) => this.props.userListCall(userList)}
