...
class Index extends Component {
    ...
    render() {
        ...
        const { rr_systolic, RR_diastolic, Search_Select, ForPatient,Falling_Risk ,No_Incidents_Sanitary_Situation,
            ask_for_incidents,
            Sanitary_Situation,
            Submit,
                                                        ...
                                                        <Grid >
                                                            ...
                                                            <Grid className="anamneSecMid">
                                                                ...
                                                                <Grid className="anamneSecMid">
                                                                    ...
                                                                    <Grid className="anamneSec">
                                                                        <FormControl>
                                                                            <FormLabel>{what_was_today} (every 2 Weeks  If not acute daily)</FormLabel>
                                                                            <FormControlLabel
                                                                                control={
                                                                                    <Checkbox
